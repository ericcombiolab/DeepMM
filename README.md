...
- CAMI-type: (270, 27)
  ...
  wget -P ./finetune-model-weight https://zenodo.org/records/14863005/files/cami_finetune_checkPoint.pt 
  ```
...
### Download reference
```
wget https://zenodo.org/records/14863005/files/reference.tar.gz 
```
