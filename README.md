...
- default: (200, 20)
  ...
  wget -P ./pretrain-model-weight https://zenodo.org/records/15589989/files/checkpoint.pt
  ```
- CAMI-type: (270, 27)
  ```
  mkdir -p ./finetune-model-weight 
  wget -P ./finetune-model-weight https://zenodo.org/records/15589989/files/cami_finetune_checkPoint.pt
  ```
...
### Download reference
```
wget https://zenodo.org/records/15589989/files/reference.tar.gz
wget https://zenodo.org/records/15589989/files/genome_list.tsv
```
