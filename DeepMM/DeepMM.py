...
def get_opts(options):
    ...
    correct.add_argument('--contig_threads', default=8, type=int, help='Maximum number of threads [default: 8]')
    correct.add_argument('--window_threads', default=8, type=int, help='Maximum number of threads [default: 8]')
    ...
    correct.add_argument('--threshold', default=0.9)
